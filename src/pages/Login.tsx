...
import { Music, Eye, EyeOff, Mail, Lock } from 'lucide-solid';
import { login, createDemoUser } from '../stores/authStore';
      ...
      <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
          ...
          <h2 class="text-3xl font-bold text-white">
            Bem-vindo à <span class="text-fire-red-500">ROCKSHOP</span>
          </h2>
          ...
          <div class="bg-metal-900 rounded-xl p-8 space-y-6 border border-metal-800">
            ...
            <div class="border-t border-metal-800 pt-4">
              <button
                ...
                class="w-full text-metal-500 hover:text-metal-300 text-sm transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-fire-red-500 rounded-md px-2 py-1"
              >
